...
class FormHelper {
    ...
    protected function attributes($attributes, $isMultiple, $valueAttribute = true) {
        ...
        #print $this->values[$attributes['name']];
        ...
        if ($valueAttribute && isset($attributes['name']) && array_key_exists($attributes['name'], $this->values) && $attributes['type'] != 'radio') { 
    ...
    protected function options($name, $options) { 
        ...
        foreach($options as $k => $v) {
            ...
            if ($this->isOptionSelected($name, $k)) { $s .= ' selected'; } 
    ...
    protected function isOptionSelected($name, $value) { 
        ...
        // in the values array 
        else { return $value == $this->values[$name]; } 
    }
